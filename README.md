The project uses : CNN Architecture and uses the trained model to integrate the system using Python Libraries like Keras, Pandas, Matpoltlib etc. and uses TKinter as the GUI interface.
Initial Page : 
